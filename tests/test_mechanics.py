...
class TestMechanic(unittest.TestCase):
    ...
    def test_create_mechanic(self): # Test creating a new mechanic with new email as we already have one in the database
    ...
    def test_email_already_exists(self): # Test creating a mechanic with an email that already exists in the database
    ...
    def test_login_mechanic(self): # Test mechanic login with valid credentials
    ...
    def test_login_invalid_credentials(self): # Test mechanic login with invalid credentials
    ...
    def test_update_mechanic(self): # Test updating an existing mechanic
    ...
    def test_delete_mechanic(self): # Test deleting an existing mechanic
        headers = {'Authorization': f'Bearer {self.token}'}
